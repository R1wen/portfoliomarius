...
export const AboutSection = ({ data }: AboutProps) => {
  return (
    <section
      id="about"
      className="py-12 md:py-20 lg:py-32 bg-white overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            <span className="text-blue-600 font-bold mb-3 md:mb-4 block uppercase tracking-wider text-sm md:text-base">
              À Propos de moi
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-4xl lg:text-5xl font-extrabold mb-6 md:mb-8 text-gray-900 leading-tight">
              Je conçois des stratégies <br className="hidden sm:block" />{" "}
              <span className="text-blue-600">qui transforment.</span>
            </h2>
